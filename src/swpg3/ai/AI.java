...
public class AI {
	...
	// ##################################################
	/**
	 * Stone Count Parameter: The factor with which one percent of field-control
	 * flows into the evaluation function
	 */
	public static double STONE_COUNT_BONUS = 5;

	/**
	 * Stone Count Parameter - Expectancy Function: The percentage of field control
	 * which is expected at the beginning of the game (filling degree 0%)
	 */
	public static double	SC_SV;
	/**
	 * Stone Count Parameter - Expectancy Function: The percentage of field control
	 * which is expected at the turning point of the game
	 */
	public static double	SC_TV;
	/**
	 * Stone Count Parameter - Expectancy Function: The percentage of field control
	 * which is expected at the end of the game (filling degree 100%)
	 */
	public static double	SC_EV;
	/**
	 * Stone Count Parameter - Expectancy Function: The turning point of the game in
	 * the interval [0,1] where the value represents the filling degree of the map
	 */
	...
	/**
	 * Stone Count Parameter - Importance Function: Decay Factor in interval [0,1]
	 * representing the importance of the stone count at the beginning of the game
	 * (filling degree 0%)
	 */
	public static double	SC_SV_I	= 0.35;
	/**
	 * Stone Count Parameter - Importance Function: Decay Factor in interval [0,1]
	 * representing the importance of the stone count at the turning point of the
	 * game (filling degree turning point)
	 */
	...
	/**
	 * Stone Count Parameter - Importance Function: The turning point of the game in
	 * the interval [0,1] where the value represents the filling degree of the map
	 */
	...
	/**
	 * Mobility Parameter: The factor with which one possible non-override move
	 * flows into the evaluation function
	 */
	public static double MOBILITY_BONUS = 20;

	/**
	 * Mobility Parameter - Expectancy Function: The number of non-override moves
	 * which are expected at the beginning of the game (filling degree 0%)
	 */
	public static double M_SV;

	/**
	 * Mobility Parameter - Expectancy Function: The maximum number of possible
	 * non-override moves which are expected through the game
	 */
	public static double M_MV;

	/**
	 * Mobility Parameter - Expectancy Function: The number of possible non-override
	 * moves which are expected at the end of the game (filling degree 100%)
	 */
	public static double M_EV;

	/**
	 * Mobility Parameter - Expectancy Function: The point the mobility is expected
	 * to reach the maximum. Value in interval [0,1] representing the filling degree
	 * of the map
	 */
	...
	/**
	 * Mobility Parameter - Expectancy Function: The point the mobility is expected
	 * to leave the maximum. Value in interval [0,1] representing the filling degree
	 * of the map
	 */
	...
	// Mobility importance
	/**
	 * Mobility Parameter - Importance Function: Decay factor in interval [0,1]
	 * determining the importance-loss of mobility for every turn till own turn
	 */
	...
	/**
	 * Override Count Parameter: The factor with which one override stone flows into
	 * the evaluation function
	 */
	public static double OVERRIDE_BONUS = 250;

	/**
	 * Override Count Parameter - Importance Function: Decay factor in interval
	 * [0,1] representing the importance of the override stones
	 */
	public static double OVERRIDE_IMPORTANCE = 1;

	// PositionalPlay parameters
	/**
	 * Positional Play Parameter: The factor with which the control of one solid
	 * stone flows into the evaluation function
	 */
	...
	/**
	 * Positional Play Parameter - Importance Function: Decay Factor in interval
	 * [0,1] representing the importance of the stone count at the beginning of the
	 * game (filling degree 0%)
	 */
	public static double PP_SV_I = 1;

	/**
	 * Positional Play Parameter - Importance Function: Decay Factor in interval
	 * [0,1] representing the importance of the stone count at the turning point of
	 * the game
	 */
	...
	/**
	 * Positional Play Parameter - Importance Function: Decay Factor in interval
	 * [0,1] representing the importance of the stone count at the end of the game
	 * (filling degree 100%)
	 */
	public static double PP_EV_I = 0;

	/**
	 * Positional Play Parameter - Importance Function: The turning point of the
	 * game in the interval [0,1] where the value represents the filling degree of
	 * the map
	 */
	 ...
	 * Initializes the used tools like Analyser, Calculator and Evaluator. Analyzes
	 * the map with the Analyser and calls the setParameters Method
	 **/
	 ...
	 * 
	 * @param playerNumber
	 *            - the point of view's playerNumber
	 * @param depthLimit
	 *            - the maximum depth which is allowed to be reached
	 * @param timeLimit
	 *            - the maximum time which is allowed to be used
	 * @return the best move according to the evaluation-function of the used
	 *         Evaluator
	 */
	...
	/**
	 * Private Method to set some evaluation function parameters. Most importantly
	 * this method sets the crucial turning point for all Importance Functions.
	 */
	private void setParameters()
	{
		...
		int movesToEnd2 = 8;
		double turnPoint2 = (PLAYABLE_SQUARES - (numberOfPlayers * movesToEnd2)) / ((double) PLAYABLE_SQUARES);
